<div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="flex" id="post-<?php echo e($reply->id); ?>">
            <div class="w-full">
                    ...
                    <tbody>
                        <tr class="flex">
                            ...
                            <td class="table-cell text-center border-t border-l w-44 bg-zinc-800/10 border-neutral-800">
                                ...
                                <div class="<?php if($reply->user->avatar_bg): ?> user-bg <?php endif; ?>"
                                    <?php if($reply->user->avatar_bg): ?> style="background-image: linear-gradient(to bottom, rgba(32, 32, 32, .5), rgba(25, 26, 30, 5)), url(<?php echo e($reply->user->avatar_bg); ?>);" <?php endif; ?>>
                                    <div class="pt-5 user-info">
                                        <div class="flex-row">
                                            <?php if($reply->user->is_banned): ?>
                                                <a href="<?php echo e(route('profile.show', $reply->user)); ?>"
                                                    class="relative overflow-hidden text-xl font-black text-center"
                                                    style="color: <?php echo e($reply->user->getUsernameColor()); ?>;">
                                                    <strike><?php echo e($reply->user->username); ?></strike>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('profile.show', $reply->user)); ?>"
                                                    class="relative overflow-hidden text-xl font-black text-center"
                                                    style="color: <?php echo e($reply->user->getUsernameColor()); ?>;">
                                                    <span
                                                        <?php if($reply->user->isInGroup('Upgrade 1') || $reply->user->isInGroup('Upgrade 2')): ?> style="background:url(https://i.imgur.com/lbPOgse.gif)" <?php endif; ?>><?php echo e($reply->user->username); ?></span>
                                                </a>
                                            <?php endif; ?>
                                        </div>
                                        <?php if($reply->user->is_banned): ?>
                                    ...
                                    <p class="py-3">
                                        <a href="<?php echo e(route('profile.show', $reply->user)); ?>">
                                            <img src="<?php echo e($reply->user->avatar); ?>"
                                                class="rounded-md inline-block text-6xl h-32 w-32 object-cover bg-center overflow-hidden align-bottom <?php echo e($reply->user->hasBeenOnlinePast15Minutes() ? 'online-border' : ''); ?>"
                                                alt="username">
                                        </a>
                                    </p>
                                </div>
                                ...
                                <div class="flex px-8 mb-4 space-x-4 justify-evenly">
                                    <div>
                                        <span
                                            class="font-bold text-xl <?php echo e($reply->user->totalReputation() > 0 ? 'text-green-600' : ($reply->user->totalReputation() < 0 ? 'text-red-600' : 'text-gray-600')); ?>"><?php echo e($reply->user->totalReputation()); ?></span>
                                        <p class="text-xs font-bold text-neutral-500">Rep</p>
                                    </div>
                                    <div>
                                        <span
                                            class="font-bold text-xl <?php echo e($reply->user->vouches->count() > 0 ? 'text-green-600' : ($reply->user->vouches->count() < 0 ? 'text-red-600' : 'text-gray-600')); ?>"><?php echo e($reply->user->vouches->count()); ?></span>
                                        <p class="text-xs font-bold text-neutral-500">Vouches</p>
                                    </div>
                                </div>
                                <?php if($reply->user->show_displayed_group == 1 && $reply->user->displayedGroup): ?>
                                    <div class="flex px-8 mb-4 space-x-4 justify-evenly">
                                        <div>
                                            <img src="<?php echo e(asset('storage/' . $reply->user->displayedGroup->group_avatar)); ?>"
                                                alt="">
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="px-4 mb-2 text-neutral-500">
                                    <div class="px-2 py-1 text-sm font-bold flex rounded bg-[#1D1E22] justify-between">
                                        ...
                                        <span>
                                            <?php echo e($reply->user->post_count); ?>
                                ...
                                <div class="px-4 mb-2 text-neutral-500">
                                    <div class="px-2 py-1 text-sm font-bold flex rounded bg-[#1D1E22] justify-between">
                                        ...
                                        <span>
                                            <?php echo e($reply->user->topic_count); ?>
                                ...
                                <div class="px-4 mb-2 text-neutral-500">
                                    <div class="px-2 py-1 text-sm font-bold flex rounded bg-[#1D1E22] justify-between">
                                        ...
                                        <span>
                                            <?php echo e(optional($reply->user->created_at)->format('M Y')); ?>
                                ...
                                <div class="px-4 mb-2 text-neutral-500">
                                    <div class="px-2 py-1 text-sm font-bold flex rounded bg-[#1D1E22] justify-between">
                                        ...
                                        <span>
                                            <?php echo e($reply->user->credit); ?>

                                        </span>
                                    </div>
                                </div>
                                <?php if($reply->user->awards->count() > 0): ?>
                                    <div class="px-4 mb-2 text-neutral-500">
                                        <div
                                            class="grid grid-cols-5 px-4 py-2 text-sm font-bold rounded bg-[#1B1B1B] justify-center">
                                            <?php $__currentLoopData = $reply->user->awards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $award): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img src="<?php echo e(asset('storage/' . Str::after($award->icon, 'public/'))); ?>"
                                                    class="w-6 h-6" alt="<?php echo e($award->name); ?>">
                            ...
                            <td class="flex-1 p-5 px-5 border bg-zinc-800/50 border-neutral-800">
                                <div class="flex items-center justify-between p-2 py-1 rounded-md bg-zinc-800/90 ">
                                        ...
                                        <span class="flex items-center text-neutral-600">
                                            ...
                                            <p class="text-sm font-bold text-neutral-400">Posted
                                                ...
                                                <?php if($reply->created_at != $reply->updated_at): ?>
                                                    - Edited <?php echo e($reply->updated_at->diffForHumans()); ?>
                                    ...
                                    <div class="flex space-x-4">
                                        <a href="#"
                                            class="px-2 py-1 text-sm font-bold rounded-md">#<?php echo e(($currentPage - 1) * $perPage + $loop->iteration); ?></a>
                                    </div>
                                </div>
                                <div class="markdown">
                                    <p class="p-2 pt-4 markdown">
                                        <?php echo Str::markdown($reply->content); ?>

                                    </p>
                                    <?php if($reply->user->signature): ?>
                                        <hr class="h-px my-8 border-0 bg-neutral-700">
                                        <div class="markdown ">
                                            <?php echo Str::markdown($reply->user->signature); ?>
                        ...
                        <tr class="flex ">
                            <td class="w-full py-4 border-b border-l border-r bg-zinc-800/10 border-neutral-800">
                                ...
                                <div class="flex items-center justify-between px-4">
                                    <div class="flex space-x-4">
                                        <?php if($reply->isLikedByUser(auth()->user())): ?>
                                            <form action="<?php echo e(route('posts.like.destroy', $reply)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <form action="<?php echo e(route('posts.like.store', $reply)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_posts')): ?>
                                            <a href="<?php echo e(route('posts.edit', ['topic' => $reply->topic->slug, 'post' => $reply->slug])); ?>"
                                                class="inline-flex items-center gap-0.5 justify-center overflow-hidden text-sm font-medium transition rounded-md bg-zinc-900 py-1 px-3 hover:bg-zinc-700 bg-cyan-400/10 text-cyan-400 ring-1 ring-inset ring-cyan-400/20 hover:bg-cyan-400/10 hover:text-cyan-300 hover:ring-cyan-300">
                                        ...
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_post')): ?>
                                            <form
                                                action="<?php echo e($reply->is_first_post ? route('topics.destroy', ['category' => $reply->topic->category->slug, 'topic' => $reply->topic->slug]) : route('posts.destroy', ['topic' => $reply->topic->slug, 'post' => $reply->slug])); ?>"
                                                method="POST"
                                                onsubmit="return confirm('Are you sure you want to delete this <?php echo e($reply->is_first_post ? 'topic' : 'post'); ?>?');">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button
                                                    class="inline-flex items-center gap-0.5 justify-center overflow-hidden text-sm font-medium transition rounded-md bg-zinc-900 py-1 px-3 hover:bg-zinc-700 bg-rose-400/10 text-rose-400 ring-1 ring-inset ring-rose-400/20 hover:bg-rose-400/10 hover:text-rose-300 hover:ring-rose-300">
                                        ...
                                        <button
                                            class="inline-flex items-center gap-0.5 justify-center overflow-hidden text-sm font-medium transition rounded-md bg-zinc-900 py-1 px-3 hover:bg-zinc-700 bg-cyan-400/10 text-cyan-400 ring-1 ring-inset ring-cyan-400/20 hover:bg-cyan-400/10 hover:text-cyan-300 hover:ring-cyan-300"
                                            @click="replyTo = '<?php echo e('@' . $reply->user->username); ?>'; $refs.replyInput.value = replyTo; $refs.replyInput.focus();">
                                            <svg class="inline-flex w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                <path fill-rule="evenodd"
                                ...
                                <div class="flex px-4">
                                    <ul>
                                        <?php $__empty_2 = true; $__currentLoopData = $reply->usersWhoLiked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                            <li class="pt-2 text-sm text-neutral-500">Users who liked this post:
                                                <?php echo e($user->username); ?></li>
    ...
    <?php if(!$topic->locked): ?>
        <?php if(auth()->guard()->check()): ?>
            <div class="flex">
                <div class="w-full">
                    <form action="<?php echo e(route('posts.store', [$category, 'topic' => $topic])); ?>" method="post">
                        ...
                        <button
                            ...
                            @click="setReplyTo('<?php echo e('@' . $reply->user->username); ?>')">
...
<?php /**PATH /var/www/html/Forum-OGUsers/resources/views/livewire/post-list.blade.php ENDPATH**/ ?>