<div>
    ...
    <div class="flex justify-evenly py-4">
        <div class="flex items-center">
            ...
            <p class="text-neutral-200 text-2xl">$<?php echo e(number_format($btcPrice, 2)); ?></p>
        </div>
        <div class="flex items-center">
            ...
            <p class="text-neutral-200 text-2xl">$<?php echo e(number_format($ethPrice, 2)); ?></p>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/Forum-OGUsers/resources/views/livewire/crypto-prices.blade.php ENDPATH**/ ?>