    ...
    <div class="px-4 pt-4 mx-auto lg:px-0" x-data="{ containerHeight: 'auto', updateHeight() { this.containerHeight = this.$refs.activeTab.offsetHeight + 'px'; } }" x-init="updateHeight()"
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div class="col-span-2">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('forum-tabs', [])->html();
} elseif ($_instance->childHasBeenRendered('dWZDLmn')) {
    $componentId = $_instance->getRenderedChildComponentId('dWZDLmn');
    $componentTag = $_instance->getRenderedChildComponentTagName('dWZDLmn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dWZDLmn');
} else {
    $response = \Livewire\Livewire::mount('forum-tabs', []);
    $html = $response->html();
    $_instance->logRenderedChild('dWZDLmn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            <div class="">
                <div class="px-4 pt-4 mb-4 rounded-md shadow-md bh ring-1 ring-white/10">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('crypto-prices', [])->html();
} elseif ($_instance->childHasBeenRendered('UDeN52n')) {
    $componentId = $_instance->getRenderedChildComponentId('UDeN52n');
    $componentTag = $_instance->getRenderedChildComponentTagName('UDeN52n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UDeN52n');
} else {
    $response = \Livewire\Livewire::mount('crypto-prices', []);
    $html = $response->html();
    $_instance->logRenderedChild('UDeN52n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
                <?php if($onlineAdminsAndModerators->count() > 0): ?>
                    <div class="bg-[#191a1e] rounded-md px-4 mb-4 py-4">
                        <h2 class="mb-2 text-xl text-neutral-200">Staff online</h2>
                        <ul>
                            <?php $__currentLoopData = $onlineAdminsAndModerators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex">
                                    <div>
                                        <img class="object-cover w-8 h-8 rounded-md" src="<?php echo e($user->avatar); ?>"
                                            alt="" />
                                    </div>
                                    <a href="<?php echo e(route('profile.show', $user)); ?>" clasS="ml-4 font-bold "
                                        style="style: <?php echo e($user->getUsernameColor()); ?>;"><?php echo e($user->username); ?>;</a>
                                </li>
...
<?php $component = App\View\Components\Block::resolve(['title' => __('Recent posts'),'description' => __('The latest 8 new posts')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('recent-posts', [])->html();
} elseif ($_instance->childHasBeenRendered('4CsScqe')) {
    $componentId = $_instance->getRenderedChildComponentId('4CsScqe');
    $componentTag = $_instance->getRenderedChildComponentTagName('4CsScqe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4CsScqe');
} else {
    $response = \Livewire\Livewire::mount('recent-posts', []);
    $html = $response->html();
    $_instance->logRenderedChild('4CsScqe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div class="flex bg-[#191a1e] border border-[#252525] justify-between shadow-md rounded-md px-4 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex-row ml-4">
                            <h2 class="text-2xl font-bold text-neutral-200"><?php echo e(App\Models\Topic::count()); ?>
                ...
                <div class="flex bg-[#191a1e] border border-[#252525] justify-between shadow-md rounded-md px-4 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex-row ml-4">
                            <h2 class="text-2xl font-bold text-neutral-200"><?php echo e(App\Models\Post::count()); ?>
                ...
                <div class="flex bg-[#191a1e] border border-[#252525] justify-between shadow-md rounded-md px-4 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex-row ml-4">
                            <h2 class="text-2xl font-bold text-neutral-200"><?php echo e(App\Models\User::count()); ?>
                ...
                <div class="flex bg-[#191a1e] border border-[#252525] justify-between shadow-md rounded-md px-4 py-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex-row ml-4">
                            <a href="<?php echo e(route('profile.show', $newestMember)); ?>"
                                class="text-xl font-bold text-neutral-200"><?php echo e(Str::limit($newestMember->username, 10)); ?>
            ...
            <div class="bg-[#191a1e] px-5 py-5 border border-[#252525] rounded-md shadow-md">
                ...
                <ul class="flex flex-wrap">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $activeUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if($count < 100): ?>
                            <li class="mr-2 font-bold" style="color: <?php echo e($user->getUsernameColor()); ?>;"><a
                                    href="<?php echo e(route('profile.show', $user)); ?>"><?php echo e($user->username); ?></a></li>
                            <?php $count++; ?>
                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Forum-OGUsers/resources/views/index.blade.php ENDPATH**/ ?>