        ...
        <div class="grid items-center grid-cols-3">
            <div class="">
                <ul class="flex items-center space-x-8 font-bold text-gray-200">
                                ...
                                <div x-data="{
                                    ...
                                    <div x-ref="panel" x-show="open" x-transition.origin.top.left
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828] ">
                                            ...
                                            <a href="<?php echo e(route('home.latest')); ?>"
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                            ...
                                            <a href="<?php echo e(route('latest-topics.index')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Latest Topics
                                            </a>
                                        </div>
                    ...
                    <li>
                        <a href="<?php echo e(route('home.search')); ?>">Search</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('upgrade.index')); ?>">Upgrade</a>
                    </li>
                                ...
                                <div x-data="{
                                    ...
                                    <div x-ref="panel" x-show="open" x-transition.origin.top.left
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828] ">
                                            ...
                                            <a href="<?php echo e(route('rep-logs.index')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Rep logs
                                            </a>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                            ...
                                            <a href="<?php echo e(route('vouch-logs.index')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Vouch logs
                                            </a>
                                        </div>
                                ...
                                <div x-data="{
                                    ...
                                    <div x-ref="panel" x-show="open" x-transition.origin.top.left
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828] ">
                                            ...
                                            <a href="<?php echo e(route('extra.awards')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Awards
                                            </a>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                            ...
                                            <a href="<?php echo e(route('extra.groups')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Groups
                                            </a>
                                        </div>
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                            ...
                                            <a href="<?php echo e(route('extra.members')); ?>"
                                        ...
                                        <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                            ...
                                            <a href="<?php echo e(route('extra.leaderboard')); ?>"
                                                class="flex items-center w-full first-of-type:rounded-t-md last-of-type:rounded-b-md py-2.5 text-left text-sm disabled:text-gray-500">
                                                Leaderboard
                                            </a>
                                        </div>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_forum')): ?>
                                            <div class="flex items-center space-x-2 px-4 hover:bg-[#282828]">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor" class="w-4 h-4">
                                                    <path fill-rule="evenodd"
                            ...
                            <li>
                                <div class="hidden ml-2 sm:flex sm:items-center">
                                    <div class="hidden sm:flex sm:items-center">
                                        ...
                                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('notifications-dropdown')->html();
} elseif ($_instance->childHasBeenRendered('1SMsaEo')) {
    $componentId = $_instance->getRenderedChildComponentId('1SMsaEo');
    $componentTag = $_instance->getRenderedChildComponentTagName('1SMsaEo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1SMsaEo');
} else {
    $response = \Livewire\Livewire::mount('notifications-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('1SMsaEo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
...
<?php $component->withName('heroicon-s-chat-bubble-bottom-center'); ?>
                                                ...
                                                <button x-ref="button" x-on:click="toggle()" :aria-expanded="open"
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        <img class="object-cover w-10 h-10 rounded-md "
                                                            src="<?php echo e(Auth::user()->avatar); ?>" alt="">
                                                        <div class="flex-row space-y-2">
                                                            <h2 class="font-bold"
                                                                style="color: <?php echo e(Auth::user()->getUsernameColor()); ?>;">
                                                                <?php echo e(Auth::user()->username); ?></h2>
                                                        </div>
                                                    </div>
...
<?php /**PATH /var/www/html/Forum-OGUsers/resources/views/nav2.blade.php ENDPATH**/ ?>