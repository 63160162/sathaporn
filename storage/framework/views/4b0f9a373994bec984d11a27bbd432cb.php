...
} elseif ($_instance->childHasBeenRendered('RZz1ykH')) {
    $componentId = $_instance->getRenderedChildComponentId('RZz1ykH');
    $componentTag = $_instance->getRenderedChildComponentTagName('RZz1ykH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RZz1ykH');
} else {
    $response = \Livewire\Livewire::mount('user-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('RZz1ykH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </section>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Forum-OGUsers/resources/views/forum/extra/members.blade.php ENDPATH**/ ?>